...
let AddBookComponent = class AddBookComponent {
    ...
    saveBook(formValues) {
        ...
        this.dataService.addBook(newBook)
            .subscribe((data) => console.log(data), (err) => console.log(err), () => console.log("New Book is Added"));
    }
};
...
/* harmony import */ var _core_add_header_service__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./core/add-header.service */ 5907);
/* harmony import */ var _core_log_response_service__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./core/log-response.service */ 2273);
...
AppModule = (0,tslib__WEBPACK_IMPORTED_MODULE_11__.__decorate)([
    (0,_angular_core__WEBPACK_IMPORTED_MODULE_12__.NgModule)({
        ...
        providers: [
            ...
            { provide: _angular_common_http__WEBPACK_IMPORTED_MODULE_13__.HTTP_INTERCEPTORS, useClass: _core_add_header_service__WEBPACK_IMPORTED_MODULE_8__.AddHeaderInterceptor, multi: true },
            { provide: _angular_common_http__WEBPACK_IMPORTED_MODULE_13__.HTTP_INTERCEPTORS, useClass: _core_log_response_service__WEBPACK_IMPORTED_MODULE_9__.LogResponseInterceptor, multi: true },
...
let CacheInterceptor = class CacheInterceptor {
    ...
    intercept(req, next) {
        ...
        const cachedResponse = this.cacheResponse.get(req.url);
...
let DataService = class DataService {
    ...
    getAllBooks() {
        ...
        return this.http.get('/api/books')
            .pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_2__.catchError)(err => this.handlehttpErrors(err)));
    }
...
let DashboardComponent = class DashboardComponent {
    ...
    ngOnInit() {
        ...
        if (resolvedData instanceof app_models_bookTrackerError__WEBPACK_IMPORTED_MODULE_2__.BookTrackerError) {
            console.log(`Dashboard Component Eror: ${resolvedData.friendlyMessage}`);
        }
        else {
    ...
    deleteBook(bookID) {
        ...
        }, (err) => console.log(err), () => console.log("Deletion process done"));
    }
...
let EditBookComponent = class EditBookComponent {
    ...
    ngOnInit() {
        ...
        this.dataService.getBookById(bookID)
            .subscribe((data) => this.selectedBook = data, (err) => console.log(err), () => console.log('fetched one record from books'));
        this.dataService.getoldBookById(bookID)
            .subscribe((data) => console.log(data), (err) => console.log(err), () => console.log('fetched one record from books'));
    }
    setMostPopular() {
    ...
    saveChanges() {
        ...
        this.dataService.updateBook(this.selectedBook)
            .subscribe((data) => console.log(this.selectedBook.author + "updated successfully"), (err) => console.log(err), () => console.log("updating of book successfull"));
    }
};
